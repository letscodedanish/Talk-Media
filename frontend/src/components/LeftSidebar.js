...
const LeftSidebar = () => {
    ...
    return (
        <div className='w-[20%] mt-10'>
            <div>
                <div>
                    {/* <img className='ml-5' width={"24px"} src="../image/logo.png" alt="twitter-logo" /> */}
                    <h1 className='font-bold text-2xl ml-2'>Talk Media</h1>
                </div>
                <div className='my-4'>
                    ...
                    <div onClick={logoutHandler} className='flex items-center my-2 px-4 py-2 hover:bg-gray-200 hover:cursor-pointer rounded-full'>
                     ...
                     <button className='px-4 py-2 border-none text-md bg-black w-full rounded-full text-white font-bold'>Post</button>
                </div>
            </div>
        </div>
    )
