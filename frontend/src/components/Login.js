  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
      <div className='flex items-center justify-evenly w-[80%]'>
        <div>
          {/* <img className='ml-5' width={"300px"} src="./public/logo.webp" alt="twitter-logo" /> */}
          <h1 className='text-[50px] font-bold mt-4'>See what's happening in 
          <br></br>the world right now</h1>
        </div>
        <div>
          <div className='my-5'>
            <h1 className='font-bold text-6xl'>Running now.</h1>
          </div>
          ...
          <form onSubmit={submitHandler} className='flex flex-col w-[55%]'>
            ...
            <button className='bg-black border-none py-2 my-4 rounded-full text-lg text-white'>{isLogin ? "Login" : "Create Account"}</button>
